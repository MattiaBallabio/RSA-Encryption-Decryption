...
int64_t modInverse(int64_t a, int64_t n) {
    ...
    while (rNew != 0) {
        ...
        //TODO: figure out what q is supposed to be
        auto q = r / rNew;
...
int main(int argc, char* argv[]) {
    ...
    if (argv[1][0] > 0) cerr << "argv[1][0] needs to be negative.";

    if (argv[1][1] == k) {
        if (argv[1][2] != 0) cerr << "argv[1][2] needs to be 0.";

        if (argc != 2) cerr << "argc needs to be 2.";
        ...
        if (argc != 4) cerr << "argc needs to be 4.";
